  ...
  return (
    <View className='login'>
      ...
      <View className='at-row'>
        <Text className='at-col at-col-2'>账号</Text>
        <Input className='username at-col at-col-4' placeholder='请输入账号' value={User.username} onInput={(e) => {setUser({...User, username: e.target.value})}}></Input>
      </View>
      <View  className='at-row'>
        <Text className='at-col at-col-2'>密码</Text>
        <Input className='password  at-col at-col-4' placeholder='请输入密码' password value={User.password} onInput={(e) => {setUser({...User, password: e.target.value})}}></Input>
      </View>
